...
* **_why do we choose Omega-3 enriched eggs rather than conventional eggs?_**\


> The hens are raised the conventional way. 
> The change is made to their feed. Their food is supplemented with Omega -3 (flax seeds are added to their food). 
> They have a little freedom to roam outside.
one tab of peanut oil\
...
1. Heat **_1tsp oil_** in nonstick skillet over medium-high heat until heat.\
2) Break eggs and slip into pan, one egg one time. Stay in heat for one minute and reduce heat to low.\
3. Add **_1/4 cups_** of water into the pan and cover the lid of the pan for using the water vapor to heat eggs.\
4.Hold for **_3-5 minutes_** until the whites start to set, and yolk start to become hard.\
5. Next step is open th lid and **_season a pinck of salt and pepper_**.\
6. Last step is that slide eggs onto a plate and serve. Usually I would like to add some sliced tometoes on the side. 
...
>In algebra, a quadratic equation is any equation having the form \(ax^2+bx+c\), where x represents an unknown, and a, b, and c represent known numbers such that a is not equal to 0. \
